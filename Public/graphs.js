...
var renderAgricultureData = function(yVar) {
  showLoading();
  setTimeout(function() {renderNewCSVData('2010.csv',"Total Population total population of area, in thousands",yVar, "Total Population total population of area, in thousands",yVar,"Public Supply total population served, in thousands", "county_nm","Public Supply total population served, in thousands"); hideLoading(); }, 3000);
};
